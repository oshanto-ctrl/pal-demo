    ...
    >
      <div class="container mx-auto px-4">
        <div class="text-center max-w-3xl mx-auto">
          ...
          <button
            @click="scrollToForm"
            class="bg-white text-prime-green px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105"
            data-aos="fade-up"
            data-aos-delay="400"
          >
            Contact Us
      ...
      <div class="container mx-auto px-4">
        <div class="flex flex-col lg:flex-row gap-8">
          ...
          <div class="lg:w-7/12" data-aos="fade-right">
            ...
            >
              <h2 class="text-2xl font-bold text-green-600 mb-6">Send Us a Message</h2>
...
>
              ...
              <div class="space-y-6">
                ...
                <div class="flex items-start">
                  ...
                  <div>
                    ...
                    <p class="opacity-90">
                      Akash Plaza, Room#501, Plot# 21, Road# 7/D, Dhaka Mymensingh Road, Sector : 9, Uttara, Dhaka-1230
                    </p>
                  </div>
                </div>
    ...
    <section class="py-16 bg-gray-50">
      <div class="container mx-auto px-4">
        <div class="text-center mb-12" data-aos="fade-up">
          <h2 class="text-4xl text-green-600 font-bold mb-4">Our Office</h2>
          <p class="text-gray-800 max-w-2xl mx-auto">
            Visit our headquarters for a personalized consultation and see our
 ...
 <div class="max-w-7xl mx-auto">
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
    <!-- Card 1 -->
    <div class="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl w-full max-w-md" data-aos="fade-up">
      <!-- Image Section - Optimized for building photos -->
      <div class="h-56 overflow-hidden relative">
        <img src="https://picsum.photos/seed/office-building/800/600.jpg" alt="Office Building" class="w-full h-full object-cover transition-transform duration-500 hover:scale-105" />
        <div class="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent"></div>
      </div>
      
      <!-- Content Section -->
      <div class="p-6">
        <h3 class="text-xl font-bold text-green-500 mb-3">Prime Automations Headquarters</h3>
        <p class="text-gray-600 mb-4 text-sm">Our state-of-the-art facility showcases the latest in automation technology with live demonstrations and expert consultations.</p>
        
        <!-- Contact Information -->
        <div class="space-y-4 mb-6">
          <div class="flex items-start">
            <div class="bg-green-50 p-2 rounded-lg mr-3 flex-shrink-0">
              <svg class="w-5 h-5 text-prime-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <p class="text-gray-600 text-xs mt-1">Akash Plaza, Room#501<br>Plot# 21, Road# 7/D<br>Dhaka Mymensingh Road<br>Sector: 9, Uttara, Dhaka-1230</p>
            </div>
          </div>
          ...
          <div class="flex items-start">
            ...
            <div>
              <h4 class="font-semibold text-sm">Contact</h4>
              <p class="text-gray-600 text-xs mt-1">
                <a href="tel:+8801769093465" class="hover:text-prime-green transition-colors">+880 17-6909-3465</a>
              </p>
            </div>
          </div>
          ...
          <div class="flex items-start">
            ...
            <div>
              <h4 class="font-semibold text-sm">Hours</h4>
              <p class="text-gray-600 text-xs mt-1">Mon - Fri: 9:00 AM - 6:00 PM<br>Closed on weekends</p>
            </div>
          </div>
        </div>

        <button @click="scrollToForm" class="w-full bg-prime-green hover:bg-deep-sea-green text-white font-medium py-3 px-4 rounded-lg transition-all duration-300 text-sm flex items-center justify-center">
...
const validateForm = () => {
  ...
  return (
    !errors.fullName && !errors.email && !errors.message && !errors.recaptcha && !errors.agree
  );
};
