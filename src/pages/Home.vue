    ...
    <section class="py-16 bg-white">
      <div class="container mx-auto px-4">
        ...
        >
          ...
          >
            <img
              src="https://picsum.photos/seed/ceo/150/150.jpg"
              alt="CEO"
            ...
            <div class="flex-1 text-center md:text-left">
              ...
              <p class="mb-4">
                "At Prime Automations Limited, we believe in pushing the
                boundaries of what's possible. Our commitment to innovation and
                excellence drives us to deliver solutions that transform
                industries and create lasting value for our partners."
              </p>
